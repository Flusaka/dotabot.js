...
describe('TimeOnly Tests', () => {
    ...
    ])('parse should return valid TimeOnly object with correct time if input time string is valid', (timeString, expected) => {
        // 1. Arrange
    ...
    test.each([
        ...
        ['01:60'],
        ['-01:00']
    ])('parse should throw if input time string is invalid', (timeString) => {
        // 1. Arrange
    ...
    ])('toString should return time string in correct format', (timeOnly, timeString) => {
